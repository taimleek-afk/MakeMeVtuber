...
public class MakeMeVtuberSettings {
    ...
    public ChromaKey getChromaKey() { return currentChromaKey; }
    public void setChromaKey(ChromaKey key) { this.currentChromaKey = key; }

    public boolean isMouthEnabled() { return mouthEnabled; }
    public void setMouthEnabled(boolean enabled) { this.mouthEnabled = enabled; }

    public float getMicThreshold() { return micThreshold; }
    public void setMicThreshold(float threshold) {
        this.micThreshold = Math.max(0.0f, Math.min(1.0f, threshold));
    }

    public float getMouthOffsetX() { return mouthOffsetX; }
    public float getMouthOffsetY() { return mouthOffsetY; }
